@extends('layouts.app', ['pageTitle' => 'ΣΥΝΟΨΗ'])
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    @if (isset($data['this_week'][$date], $data['this_week'][$date][0]))
                                        ...
                                        &nbsp;
                                        <span class="f-500 c-crm p-r-10">&euro;{{ $data['this_week'][$date][0]->sum or '' }}</span>
                ...
                <tbody>
                    @foreach ($data['average_per_dayofweek'] as $row)
                        <tr>
                            ...
                            <td class="text-right">
                                <span class="f-500 c-crm">&euro;{{ number_format($row->sum / $row->days, 0, ',', '.') }}</span>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
                        ...
                        @foreach ($data['sum_per_year'] as $year)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    &nbsp;
                                    <span class="f-500 c-crm">&euro;{{ number_format($year->sum, 0, ',', '.') }}</span>
                        ...
                        @foreach ($data['sum_per_month'] as $month)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    &nbsp;
                                    <span class="f-500 c-crm">&euro;{{ number_format($month->sum, 0, ',', '.') }}</span>
